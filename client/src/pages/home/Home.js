    ...
    <div>
      ...
      <div className="salon_body">
        <div className="welcome_topic">
          {" "}
          <h1>Welcome to Salon REBEL</h1>
        </div>

        <div className="welcome">
          <div className="welcome_des">
            <p>
              Welcome to Salon REBEL, where beauty meets nature in the most
              ...
              <br></br>
              At Salon Natural REBEL, we understand that your wedding day is
              ...
              Natural REBEL offers a sanctuary of relaxation and rejuvenation.
              ...
              <br></br>
              Experience the magic of Salon Natural REBEL and embark on a
        ...
        <div className="about-image">
          <div className="about-text">
            ...
            <p>
              Welcome to Salon REBEL, a haven of beauty nestled in the heart of
              Kalutara, curated by the visionary owner R.M. Shiromi Malika.
              ...
              <br></br>
              <br></br>
              Founded by R.M. Shiromi Malika, Salon REBEL embodies her belief
              ...
              <br></br>
              <br></br>
              At Salon REBEL, we take pride in our meticulous attention to
              ...
              life. Located in the vibrant city of Kalutara, Salon Natural
              ...
              <br></br>
              Experience the magic of Salon REBEL and discover the beauty that
