...
import Recommendation from './pages/recommendation/recommendation'; // ✅ Import Hair Recommendation Page
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/recommendation" element={<Recommendation />} /> {/* ✅ Added Route for Hair Recommendation */}
      </Routes>
    </>
  );
}
